...
+ Агенты и их стейты.
+ Правила (обычно стейт‑машины).
+ Итерационный просчёт циклов, в том числе ограничение количества циклов максимумом
   (так как подразумевается, что симуляция стартует и оканчивается не один раз).
+ Менеджер статистики, который также при необходимости может вести историю:
   событий, действий и решений.
+ Менеджер существования агентов, по сути отвечающий за управление и расстановку
