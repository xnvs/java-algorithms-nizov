...
Этот репозиторий содержит последнюю и актуальную версию книги.
Версия в файле обновляется реже и отстает по правкам.

Текущее обновление `февраль 2026`. Глобальная вычитка и пересборка производится 
один раз в год ближе к декабрю. 
...
Оглавление
==========
*   [Интро](ax000-intro.md)
*   [Почему эта книга? : Введение](ax001-why-this-book.md)

Общие навыки
---
*   [Продуктивность: Борьба с прокрастинацией](ax002-productivity-procrastination.md)
*   [Продуктивность: Работа со страхами и переживаниями](ax003-productivity-overcoming-fears.md)
*   [Графическое мышление относительно структур данных](ax004-visual-thinking-data-structures.md)

Структуры данных
---
*   [Структура данных: Массивы](ax005-data-structures-arrays.md)
*   [Структура данных: Стек](ax006-data-structures-stack.md)
*   [Структура данных: Сет](ax007-data-structures-set.md)
*   [Структура данных: ЛинкдЛист](ax008-data-structures-linked-list.md)
*   [Структура данных: Дерево](ax009-data-structures-tree.md)
*   [Структура данных: Хешмапы](ax010-data-structures-hashmaps.md)
*   [Структура данных: Очереди и Деки](ax011-data-structures-queues-deques.md)
*   [Структура данных: Куча](ax012-data-structures-heap.md)
*   [Структура данных: Графы Интро](ax013-data-structures-graphs-intro.md)
*   [Структура данных: Префиксные деревья Интро](ax014-data-structures-trie-prefix-trees.md)

Примитивные алгоритмы
---
*   [Примитивные алгоритмы: Теория табличного тестирования](ax015-algorithms-table-driven-testing.md)
*   [Примитивные алгоритмы: Факториал](ax016-algorithms-factorial.md)
*   [Примитивные алгоритмы: Фибоначчи](ax017-algorithms-fibonacci.md)
*   [Примитивные алгоритмы: Поиск](ax018-algorithms-search-basics.md)
*   [Примитивные алгоритмы: Сортировки](ax019-algorithms-sorting-basics.md)
*   [Мышление паттернами](ax020-pattern-thinking.md)
*   [Разбор эволюции кода](ax021-code-evolution-analysis.md)
*   [Финализация относительно рекурсии](ax022-recursion-finalization.md)
...
*   [Two Pointers (два указателя) алгоритмы](ax031-algorithms-two-pointers.md)
*   [Sliding Window (скользящее окно) алгоритмы](ax032-algorithms-sliding-window.md)
*   [BFS (Breadth First Search) Поиск в ширину, DFS (Depth First Search) глубину алгоритмы](ax033-algorithms-bfs-dfs.md)
...
*   [Побитовые операции (Bit Manipulation)](ax039-bit-manipulation.md)
*   [Алгоритмы на базе монотонности и монотонного стека (Monotonic Stack)](ax040-algorithms-monotonic-stack.md)
*   [Алгоритмы на базе Префиксной суммы (PrefixSum)](ax041-algorithms-prefix-sum.md)
*   [Алгоритмы на базе Rolling Hash](ax042-algorithms-rolling-hash.md)
*   [Имитационное моделирование (Симуляция-Simulation)](ax043-algorithms-simulation.md)

Приложения
---
*   [Приложение. Масштабирование алгоритмов](ax044-algorithms-scaling.md)
*   [Приложение. Пермутации, комбинации, вероятность, Монте Карло](ax045-algorithms-permutations-combinations-probability-monte-carlo.md)

Решебник
---
*   [Решебник. Framework](ax046-solutions-framework.md)


*   [Решебник. MonotonicStack_DailyTemperatures](ax047-solutions-monotonic-stack-daily-temperatures.md)
*   [Решебник. OverlappingIntervals_NonOverlappingIntervals](ax048-solutions-overlapping-non-overlapping-intervals.md)


*   [Решебник. Путешествия по деревьям](ax049-solutions-tree-traversals.md)
...
Шпаргалка
---
*   [Шпаргалка](ax095-solutions-algorithms-cheat-sheet.md)
*   [Заключение](ax999-conclusion.md)
